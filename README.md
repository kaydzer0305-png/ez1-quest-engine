...
- ✅ **Public-tree scaffolding for the engine seam**: stub render hook
  (per-eye clear + stereo marker) + gated `LauncherMain` boot attempt,
  driven by `EZQUEST_VR_STUB_HOOK` / `EZQUEST_VR_TRY_ENGINE` after the
  first presented XR frame. See `docs/vr-integration.md`.
